/* PrismJS 1.11.0
http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript&plugins=normalize-whitespace */
...
!function () {
    ...
    e.prototype = {
        ...
        if (!e.settings || e.settings["whitespace-normalization"] !== !1) {
            ...
            var t = e.element.parentNode, r = /\bno-whitespace-normalization\b/;
